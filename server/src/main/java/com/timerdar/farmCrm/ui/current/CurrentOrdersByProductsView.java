...
public class CurrentOrdersByProductsView extends EntitiesListView {
	...
	@Autowired
	public CurrentOrdersByProductsView(ProductService productService, ConsumerService consumerService, OrderService orderService){
